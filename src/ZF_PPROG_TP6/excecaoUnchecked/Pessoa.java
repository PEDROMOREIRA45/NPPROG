...
public class Pessoa implements Comparable<Pessoa> {
     ...
     */
    public final void setIDCivil(int idCivil) {
        if(idCivil<0 || idCivil>99999999)
            //      throw new ArgumentoForaDosLimitesException();
            throw new ArgumentoForaDosLimitesException("Nº de ID Civil fora dos limites!");
