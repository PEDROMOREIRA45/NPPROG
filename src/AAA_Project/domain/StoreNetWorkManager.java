...
public class StoreNetWorkManager extends Employee implements PersonInterface{
    ...
    public StoreNetWorkManager(String email,int numberCitizen, int tin,int phoneNumber, String name ) {
